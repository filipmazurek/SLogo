...
/**
 * This class is used as the front-facing interface for saving and loading features. This class is best accessed
 * by whatever class may give it the required classes for saving functions and variables, and if loading, may
 * properly set the required classes.
 */
