...
/**
 * The Turtle which may hold all its information, which will then be used to draw all required lines
 * in the front end. This class is held in the TurtleStorage.
 */
