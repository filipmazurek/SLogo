...
/**
 * A managerial class which serves to be a holder for multiple data-storing classes. This class is exclusively for
 * ease of use and organization within the code.
 *
